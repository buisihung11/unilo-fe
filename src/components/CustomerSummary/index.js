...
function CustomerProfile(props) {
  ...
  return (
    <div className={'d-flex align-items-center flex-column ml-2'}>
...
export default function CustomerSummary(props) {
  return (
    <StyledCustomerSummaryWrapper>
      <div
        className={
          'd-flex align-items-center justify-content-around h-100'
        }
      >
        <CustomerProfile />
        <div
          className={
            'd-flex flex-column justify-content-between mr-2'
          }
        >
